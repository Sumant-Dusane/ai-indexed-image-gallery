...
Also read the `CLAUDE.md` inside the directory you are about to modify (e.g., `lib/core/CLAUDE.md`, `rust/CLAUDE.md`).
...
Each directory with a `CLAUDE.md` — read it before modifying files in that directory.
...
3. Read the `CLAUDE.md` files for directories you will modify
