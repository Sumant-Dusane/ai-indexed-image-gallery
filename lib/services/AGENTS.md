...
- Services call inference via `lib/core/repositories/inference_repository.dart` — never call ONNX sessions directly
...
- Inference runtime calls → `lib/core/repositories/inference_repository.dart`
